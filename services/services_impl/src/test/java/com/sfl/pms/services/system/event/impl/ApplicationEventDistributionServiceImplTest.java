package com.sfl.pms.services.system.event.impl;
...
public class ApplicationEventDistributionServiceImplTest extends AbstractServicesUnitTest {
    ...
    public void testPublishSynchronousEvent() {
        // Test data
        final ApplicationEvent applicationEvent = new DummyApplicationEvent();
        // Reset
        resetAll();
        // Expectation
    ...
    /* Inner classes */
    private static class DummyApplicationEvent implements ApplicationEvent {

        /* Constructors */
        public DummyApplicationEvent() {
        }
    }
}
